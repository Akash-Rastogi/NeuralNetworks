...
class CL_ActivationFunctions():
    ...
    def __init__(self, master):
        ...
        self.learning_method_dropdown=Tk.OptionMenu(self.buttons_frame,self.learning_method_variable, "Sigmoid","Linear", "Hyperbolic Tangent", "Positive linear",
    ...
    def display_activation_function(self):
        ...
        if self.learning_method=='Sigmoid':
            ...
            activation = np.sinh(net_value)/np.cosh(net_value)
            #Second value of activation can also be used.
